...
def create_enemy():
    enemy_size = (30, 30)
    enemy = pygame.image.load('enemy.png').convert_alpha() # enemy = pygame.Surface(enemy_size)
...
def create_bonus():
    bonus_size = (25, 25)
    bonus = pygame.image.load('bonus.png').convert_alpha() # bonus = pygame.Surface(bonus_size)
